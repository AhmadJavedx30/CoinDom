async function fetchdata() {
    try {
        ...
        ethereumChangeTop.innerText = `${data.bitcoin.usd_24h_change.toFixed(2)}%`;
        let ethcoin24hrChangeTop = `${data.bitcoin.usd_24h_change}`
        ...
        tetherChangeTop.innerText = `${data.bitcoin.usd_24h_change.toFixed(2)}%`;
        let tethcoin24hrChangeTop = `${data.bitcoin.usd_24h_change}`
        ...
        bnbChangeTop.innerText = `${data.bitcoin.usd_24h_change.toFixed(2)}%`;
        let bnbcoin24hrChangeTop = `${data.bitcoin.usd_24h_change}`
